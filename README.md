...
# Model
A modifed version of Convolutional Recurrent Neural Networks Model ([CRNN](https://arxiv.org/pdf/1507.05717v1.pdf)) is used to architect the classification model.
...
For detailed model architecture and its parameters, check the `Define model` code part of the notebook [Language-Classification.ipynb](../master/Language-Classification.ipynb)
